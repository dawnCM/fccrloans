...
<div id="ws_pghd_wrap">
	<div class="container">
    	<div class="row">
        	<div class="col-sm-12">
            	<div id="ws_logo">
                <img src="/theme/Alpha/img/ws_logo.png?1512461538" alt="" class="img-responsive" width="223" height="84"> 
                </div>
                <div id="ws_tag">
                  ...
                  <div class="tab-pane tab1" id="tab1">
                    ...
                    <div class="row">
						...
						data-parsley-group="step1">
							...
							<option value="60"<?php echo ($this->Session->read('Application.ResidentSinceDate') == '72') ? ' selected="selected"' : ''; ?>>3-5 Years</option>
                  ...
                  <div class="tab-pane tab4" id="tab4">
                    ...
                    <div class="row">
                    	<span class="additional_lenders" style="display:none";>
	                    	...
	                    	<div class="col-sm-4">
                   			...
                   			<div class="col-sm-4" style="cursor:pointer;">
		                        ...
		                        <?php echo $this->Html->image('no_bank_acct.png', array('alt'=>'No Bank Account', 'class'=>'img-responsive', 'width'=>'130', 'height'=>'30', 'id'=>'no_bank')); ?>
		                          </a>
                        </div>
                       </span>
                       <span class="additional_lenders">
                        ...
                        <a href="http://nkoeg.com/?c=100&s1=NCB" onclick="window.open('http://nkoeg.com/?c=100&s1=NCB', 'newwindow', 
                         'width=400,height=300'); return false;">
                         <?php echo $this->Html->image('no_bank_acct.png', array('alt'=>'No Bank Account', 'class'=>'img-responsive', 'width'=>'130', 'height'=>'30', 'id'=>'no_bank_page')); ?>
                         </a>
                        </div>
                    	<div class="col-sm-4"></div>
                    </div>
                     <div class="row" style="margin-top:20px;">
                      ...
                      <div class="col-sm-8 col-sm-offset-2" style="text-align: center; border: 1px solid #ccc; ">
                        ...
                        <p style="font-weight: normal;">Sign up to receive SMS Alerts from Peer Point Funding with your
