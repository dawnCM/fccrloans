          ...
          <form method="post" id="basicWizard" class="panel-wizard">        
              <div class="tab-content">
                  <div class="tab-pane tab5" id="tab5" style="display:initial;">
                      ...
                      <?php echo $this->Html->link($this->Html->image('OneMain-Banner.jpg', array('alt'=>'OneMain', 'width'=>'340', 'height'=>'270', 'class'=>'img-responsive')), 'http://nkoeg.com/?c=108&s1=TY', array('target'=>'_blank','escape'=>false)); ?>
