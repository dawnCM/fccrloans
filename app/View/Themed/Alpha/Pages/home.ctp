...
<div class="row">
            <div class="col-sm-12">
                <div id="ws_mast_lcol">
                    ...
                    <div class="ws_mast_loantxt" style="padding-top: 50px">
                    Personal Loans
                    </div>
                    <div class="ws_row">
                        <div class="ws_mast_smtxt" style="padding-right: -10px;width:130px">
                        up to
                        </div>
                        <div class="ws_mast_lgtxt" style="width:90%">
                        $5,000
                        </div>
                    </div>
                </div>
                <div id="ws_mast_rcol">
                    <div id="ws_formboxp1"><form class="form-horizontal" role="form" id="LeadInForm" action="/application" method="post">
