 ...
 */
Configure::write('Global.Domain','https://accesspointlending.xyz');
...
Configure::write('Offers.Organic.OfferId', '49');
Configure::write('Offers.Organic.CampaignId', '185');
Configure::write('Offers.Organic.CreativeId', '231');
